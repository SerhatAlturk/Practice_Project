package Replits.CatalogProject;
...
public class Catalog
{
    ...
    public String getItemDetails(String item)
    {
        ...
        if(items.contains(item))
        {
            ...
            return items.get(index) + "-" + prices.get(index) + "-" + monthlyPayments.get(index);
        }
    ...
    public ArrayList<String> getItemsLessThanAMonthlyPrice(double price)
    {
        ...
        for(int i = 0; i < items.size(); i++)
        {
            index = monthlyPayments.get(i);
            if(index < price)
            {
                temp = items.get(i) + "-" + prices.get(i) + "-" + monthlyPayments.get(i);
    ...
    public void updatePrice(String item, double newPrice)
    {
        ...
        monthlyPayments.set(index, newPrice / 12);
    }
